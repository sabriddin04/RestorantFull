...
{
    /// <inheritdoc />
    public partial class v34561 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Drinkses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    SizePlace = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DrinksMenu", x => new { x.DrinksId, x.MenusId });
                    table.ForeignKey(
                        name: "FK_DrinksMenu_Drinkses_DrinksId",
                        column: x => x.DrinksId,
                        principalTable: "Drinkses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DrinksMenu_Menus_MenusId",
                        column: x => x.MenusId,
                        principalTable: "Menus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuDrinks_Drinkses_DrinkId",
                        column: x => x.DrinkId,
                        principalTable: "Drinkses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenuDrinks_Menus_MenuId",
                        column: x => x.MenuId,
                        principalTable: "Menus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DrinksOrder", x => new { x.DrinksId, x.OrdersId });
                    table.ForeignKey(
                        name: "FK_DrinksOrder_Drinkses_DrinksId",
                        column: x => x.DrinksId,
                        principalTable: "Drinkses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DrinksOrder_Orders_OrdersId",
                        column: x => x.OrdersId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDrinks_Drinkses_DrinkId",
                        column: x => x.DrinkId,
                        principalTable: "Drinkses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DrinksMenu_MenusId",
                table: "DrinksMenu",
                column: "MenusId");

            migrationBuilder.CreateIndex(
                name: "IX_DrinksOrder_OrdersId",
                table: "DrinksOrder",
                column: "OrdersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuDrinks_DrinkId",
                table: "MenuDrinks",
                column: "DrinkId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuDrinks_MenuId",
                table: "MenuDrinks",
                column: "MenuId");
